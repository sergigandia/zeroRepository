...
namespace MasterOfWind
{
    class Modes
    {
        ...
        public Skills getSkills()
      {
        ...
        public void autoQTarget(Obj_AI_Hero target)
        {
            skills.qCast(target);
        }
        public void autoQMinion(Obj_AI_Hero target)
        {
            if (!skills.HaveQ3)
            {
    ...
    //        int q = p.getMenu().Item("sethQ").GetValue<Slider>().Value;
        ...
        public void gameObject_OnCreate(GameObject sender, EventArgs args2)
        {
         ...
         //   if (!(sender is Obj_SpellMissile) || !sender.IsValid)return;
            ...
            if (!args.SpellCaster.IsValid<Obj_AI_Hero>() || args.SpellCaster.IsAlly)
            {
                return;
            }
        ...
        public void lastHit(Obj_AI_Hero target)
        {
