    ...
    public static void  Do()
       ...
       Console.WriteLine("hola : " +Program.menu.Item("jpassive").GetValue<bool>().ToString());
            ...
            if (Program.Q.IsReady() && useQ)
            {
                ...
                {
                    if (Program.menu.Item("jpassive").GetValue<bool>())
                     Utility.DelayAction.Add(100, () =>   MasterOfInsec.Data.castSpell(Program.Q, "jpassive", MinionN));
                    else
            ...
            {
                if (Program.menu.Item("jpassive").GetValue<bool>())
                  Utility.DelayAction.Add(100, () =>   MasterOfInsec.Data.castSpell(Program.W, "jpassive", Program.Player));
                else
                MasterOfInsec.Data.castSpell(Program.W, "jpassive", Program.Player);
            }
            ...
            if (Program.E.IsReady() && useE)
            {
                if (MinionNe.Count >= Program.menu.Item("JMinE").GetValue<Slider>().Value)
                {
                   ...
                   Utility.DelayAction.Add(100, () =>    MasterOfInsec.Data.castSpell(Program.E, "jpassive"));
